...
<p>
 Detecting credit card fraud is essential for protecting financial systems. In this project, we use various Machine Learning algorithms to determine whether a transaction is genuine or fraudulent. Since fraudulent transactions are much less common than legitimate ones, we use SMOTE (Synthetic Minority Over-sampling Technique) to create synthetic examples of the minority class and balance the dataset.
</p>
...
<h2>👨‍💻 Author</h2>
<p>🚀 <b>Ashwini Kumar Sahu</b> | 🌍 GitHub: <a href="https://github.com/Itz-Pini">GitHub</a> | 🔗 LinkedIn: <a href="https://www.linkedin.com/in/ashwini-kumar-sahu-0520b52b8">LinkedIn</a></p>
